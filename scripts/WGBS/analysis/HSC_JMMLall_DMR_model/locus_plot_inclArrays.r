...
#create directory
dir.create("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array")

#load meth
#bsseq_all <- readRDS( file.path(input.dir ,"bsseq", "bsseq_HSC_comb_snpRemoved_repMerged.rds"))
#smooth data
#bsseq_all_smooth <- BSmooth(bsseq_all, BPPARAM = MulticoreParam(workers = 3, progressbar = TRUE))
#saveRDS(bsseq_all_smooth, file.path(input.dir ,"bsseq", "bsseq_HSC_comb_snpRemoved_repMerged_smoothed.rds"))
bsseq_all_smooth <- readRDS(file.path(input.dir ,"bsseq", "bsseq_HSC_comb_snpRemoved_repMerged_smoothed.rds"))
#load dmrs
...
anno_patient <- pData(bsseq_all_smooth)
...
#get memory
lapply(list(anno_meth,meth_per_cpg, bsseq_all_smooth, HM_array, IM_array, LM_array ), rm)
rm(anno_meth)
rm(meth_per_cpg)
rm(bsseq_all_smooth)
gc()
...
for (i in 1:length(roi)){
        ...
        #Plot track
        #pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext, "_Span",span,"_bsseqSmoot_line.pdf")), width = 10, height = 5)
        pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext,"_bsseqSmoot_Averageline.pdf")), width = 10, height = 10)
        ...
        #Plot track
        #pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext, "_Span",span,"_bsseqSmoot_line.pdf")), width = 10, height = 5)
        pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext,"_bsseqSmoot_line_point.pdf")), width = 10, height = 10)
        plotTracks(list(itrack , getrack, grtrack_original, 
            dmrs_HM, #dmrs_HMvsNormal,dmrs_LMvsNormal,
            meth_data_all_track,  LM_array_track, IM_array_track, HM_array_track),fontcolor.title="black",
            from =lim[1]-ext, to = lim[2]+ext, chromosome=Chr)
        ...
        #Plot track
        #pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext, "_Span",span,"_bsseqSmoot_line.pdf")), width = 10, height = 5)
        pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext,"_bsseqSmoot_point.pdf")), width = 10, height = 10)
        plotTracks(list(itrack , getrack, grtrack_original, 
            dmrs_HM, #dmrs_HMvsNormal,dmrs_LMvsNormal,
            meth_data_all_track, LM_array_track, IM_array_track, HM_array_track),fontcolor.title="black",
            from =lim[1]-ext, to = lim[2]+ext, chromosome=Chr)
        ...
        #Plot track
        #pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext, "_Span",span,"_bsseqSmoot_line.pdf")), width = 10, height = 5)
        pdf(file.path("/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/locus_plots/incl_array",paste0(roi[i,]$transcript_id, "_locus_","ext_",ext,"_bsseqSmoot_line_confint.pdf")), width = 10, height = 10)
        plotTracks(list(itrack , getrack, grtrack_original, 
            dmrs_HM,# dmrs_HMvsNormal,dmrs_LMvsNormal,
            meth_data_all_track, LM_array_track, IM_array_track, HM_array_track),fontcolor.title="black",
            from =lim[1]-ext, to = lim[2]+ext, chromosome=Chr)
