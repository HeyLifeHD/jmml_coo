...
saveRDS(prom_final,file.path(analysis.dir,"corr_res_sub_methylation_values.rds"))
saveRDS(expr_final,file.path(analysis.dir,"corr_res_sub_expression_values.rds"))
...
for(i in names(corr_res_sub)){
    ...
    pdf(file=file.path(analysis.dir,i, "correlation_analysis", "DMRs", "waterfall_estimate_all.pdf"), height=3.5, width=5)
...
for(i in names(corr_res_sub)){
    ...
    pdf(file=file.path(analysis.dir,i, "correlation_analysis", "DMRs", "waterfall_estimate_pvalue0.01.pdf"), height=3.5, width=5)
...
pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_RNA_signCorr0.01_estimateOrder_colClustered.pdf")
) 
pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_WGBS_signCorr0.01_estimateOrder_colClustered.pdf")
) 
...
pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_RNA_signCorr0.01_rowClusteredIndependent_colClustered.pdf")
)  
pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_WGBS_signCorr0.01_rowClusteredIndependent_colClustered.pdf")
) 
...
p <- pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps","heatmap_RNA_signCorr0.01_rowClusteredRNA_colClusteredRNA.pdf")
)  
pheatmap::pheatmap(wgbs_sig[p$tree_row$order, p$tree_col$order],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    ...
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_WGBS_signCorr0.01_rowClusteredRNA_colClusteredRNA.pdf")
) 
p <- pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_WGBS_signCorr0.01_rowClusteredWGBS_colClusteredWGBS.pdf")
) 
pheatmap::pheatmap(rna_sig[p$tree_row$order, p$tree_col$order],#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps", "heatmap_RNA_signCorr0.01_rowClusteredWGBS_colClusteredWGBS.pdf")
)  
}
...
pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_estimateOrder_colClustered.pdf")
) 
pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_estimateOrder_colClustered.pdf")
) 
...
pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredIndependent_colClustered.pdf")
)  
pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredIndependent_colClustered.pdf")
) 
...
p <- pheatmap::pheatmap(rna_sig,#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs","heatmap_RNA_signCorr0.01_rowClusteredRNA_colClusteredRNA.pdf")
)  
pheatmap::pheatmap(wgbs_sig[p$tree_row$order, p$tree_col$order],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredRNA_colClusteredRNA.pdf")
) 
...
p <- pheatmap::pheatmap(wgbs_sig,#color= RColorBrewer::brewer.pal(9,"Greens"), 
    ...
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=TRUE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredWGBS_colClusteredWGBS.pdf")
) 
...
pheatmap::pheatmap(rna_sig[p$tree_row$order, p$tree_col$order],#color= RColorBrewer::brewer.pal(9,"Blues"),
    ...
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredWGBS_colClusteredWGBS.pdf")
) 
#row clustering based on wgbs; columns based on methylation level
p <- pheatmap::pheatmap(wgbs_sig[,c( "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360")],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredWGBS_colMeanMeth.pdf")
) 

pheatmap::pheatmap(rna_sig[p$tree_row$order,c(  "cordblood","D117", "D129", "D217", "I217", "D213", "D124","D123", "D360")],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredWGBS_colMeanMeth.pdf")
) 


#row clustering based on rna; columns based on methylation level
p <- pheatmap::pheatmap(rna_sig[,c(  "cordblood","D117", "D129", "D217", "I217", "D213", "D124","D123", "D360")],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredRNA_colMeanMeth.pdf")
) 

pheatmap::pheatmap(wgbs_sig[p$tree_row$order,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360")],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredRNA_colMeanMeth.pdf")
) 
}
...
pheatmap::pheatmap(wgbs_sig_neg[,c( "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowOrdEstimate_colMeanMethh_NegativeEstimate.pdf")
) 
pheatmap::pheatmap(rna_sig_neg[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_rowOrdEstimate_rowClusteredWGBS_colMeanMeth_NegativeEstimate.pdf")
) 
}
if(nrow(wgbs_sig_pos)>1){
#positive estimate
pheatmap::pheatmap(wgbs_sig_pos[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_rowOrdEstimate_rowClusteredWGBS_colMeanMeth_PositiveEstimate.pdf")
) 
pheatmap::pheatmap(rna_sig_pos[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA__rowOrdEstimate_rowClusteredWGBS_colMeanMeth_PositiveEstimate.pdf")
)  
}
if(nrow(wgbs_sig_neg)> 1){
#row clustering based on wgbs; columns based on methylation level
#negative estimate
p <- pheatmap::pheatmap(wgbs_sig_neg[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredWGBS_colMeanMethh_NegativeEstimate.pdf")
) 
pheatmap::pheatmap(rna_sig_neg[p$tree_row$order,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredWGBS_colMeanMeth_NegativeEstimate.pdf")
) 
}
if(nrow(wgbs_sig_pos)>1){
#positive estimate
p <- pheatmap::pheatmap(wgbs_sig_pos[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredWGBS_colMeanMeth_PositiveEstimate.pdf")
) 
pheatmap::pheatmap(rna_sig_pos[p$tree_row$order,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredWGBS_colMeanMeth_PositiveEstimate.pdf")
) 
}    
if(nrow(wgbs_sig_neg)> 1){
#row clustering based on rna; columns based on methylation level
#negative estimate
p <- pheatmap::pheatmap(rna_sig_neg[,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredRNA_colMeanMeth_NegativeEstimate.pdf")
) 

pheatmap::pheatmap(wgbs_sig_neg[p$tree_row$order,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredRNA_colMeanMeth_NegativeEstimate.pdf")
) 
}
if(nrow(wgbs_sig_pos)>1){
#positive estimate
p <- pheatmap::pheatmap(rna_sig_pos[,c( "cordblood",  "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Greens"), 
    scale="row", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=TRUE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_RNA_signCorr0.01_rowClusteredRNA_colMeanMeth_PositiveEstimate.pdf")
) 

pheatmap::pheatmap(wgbs_sig_pos[p$tree_row$order,c(  "cordblood", "D117", "D129", "D217", "I217", "D213", "D124","D123", "D360"), drop=FALSE],#color= RColorBrewer::brewer.pal(9,"Blues"),
    scale="none", show_colnames=F,
    annotation_col=anno_heat,
    fontsize_row=1,
    annotation_colors=anno_colors, cluster_rows=FALSE,cluster_cols=FALSE,# clustering_distance_rows="correlation",
    show_rownames=T,
    filename= file.path(analysis.dir,i, "correlation_analysis", "DMRs", "heatmaps_degs", "heatmap_WGBS_signCorr0.01_rowClusteredRNA_colMeanMeth_PositiveEstimate.pdf")
) 
}
}
...
saveRDS(deg_overlap,file.path(analysis.dir,"corr_res_sign0.05_overlapDEGs_up_downStrat.rds") )
