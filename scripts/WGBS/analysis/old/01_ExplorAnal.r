...
analysis.dir <-  "/home/heyj/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/ExplorAnal"
dir.create(analysis.dir)
#load data
bsseq_all <- readRDS(file.path(output.dir ,"bsseq", "bsseq_all.rds"))
#bsseq_all_sub<- readRDS(file.path(output.dir , "bsseq", "bsseq_all_fil.rds"))
