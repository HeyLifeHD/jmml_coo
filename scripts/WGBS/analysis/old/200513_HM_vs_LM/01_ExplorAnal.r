...
analysis.dir <-  "/home/heyj/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/200512_ExplorAnal"
dir.create(analysis.dir)
#load data
bsseq_all <- readRDS(file.path(input.dir ,"bsseq", "bsseq_all_snpfil_all.rds"))
#subset outliers
bsseq_all <- bsseq_all[,!colnames(bsseq_all) %in% c("tumor11_JMMLC_D129_1")] 
...
saveRDS(bsseq_all, file.path(input.dir ,"bsseq", "bsseq_all_snpfil_sub.rds"))
...
ggpubr::ggboxplot(av.meth_per_cpg, x="Epigenotype", y="AverageMethylation", color="Epigenotype",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
...
ggpubr::ggboxplot(av.meth_per_cpg, x="Patient", y="AverageMethylation", color="Patient",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
ggpubr::ggboxplot(av.meth_per_cpg, x="Genotype", y="AverageMethylation", color="Genotype",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
ggpubr::ggboxplot(av.meth_per_cpg, x="Tumor", y="AverageMethylation", color="Tumor",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
ggpubr::ggboxplot(av.meth_per_cpg_cpgi, x="Epigenotype", y="AverageMethylation", color="Epigenotype",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
...
ggpubr::ggboxplot(av.meth_per_cpg_cpgi, x="Patient", y="AverageMethylation", color="Patient",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
ggpubr::ggboxplot(av.meth_per_cpg_cpgi, x="Genotype", y="AverageMethylation", color="Genotype",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
ggpubr::ggboxplot(av.meth_per_cpg_cpgi, x="Tumor", y="AverageMethylation", color="Tumor",ylim=c(0,1),# palette =c("#86868699", "#0073C299", "#CD534CFF","#EFC00099" ),
    add = "jitter")  +  
    #stat_compare_means(method="t.test", comparisons = my_comparisons,label.y = c(.80, .85, .91, .95)) + 
    #stat_compare_means(label.y = .25) +
    rremove("legend")+
...
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="row",fontsize_row=5,  filename=file.path(analysis.dir,"Heatmap20000mvCpG.pdf"))
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="none",fontsize_row=5,  filename=file.path(analysis.dir,"Heatmap20000mvCpG_noScale.pdf"))
...
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="row",fontsize_row=5, filename=file.path(analysis.dir,"Heatmap_20000mvPromoterMeth.pdf"))
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="none",fontsize_row=5,  filename=file.path(analysis.dir,"Heatmap_20000mvPromoterMeth_noScale.pdf"))
#1000 mv
...
annotop <- anno[topVarGenesRld,]
matrld <- PromoterMeth[topVarGenesRld,]
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="row",fontsize_row=5, filename=file.path(analysis.dir,"Heatmap_1000mvPromoterMeth.pdf"))
pheatmap(matrld,  annotation_col=as.data.frame(annovst),show_rownames=FALSE,show_colnames=FALSE, scale="none",fontsize_row=5,  filename=file.path(analysis.dir,"Heatmap_1000mvPromoterMeth_noScale.pdf"))
...
ggscatter(x, x="PC2", y="PC3",
          color = "group", shape = "tumor",#size="Protocol",
          ellipse = F , mean.point = FALSE,#palette=c("#86868699", "#0073C299", "#CD534CFF","#EFC00099"),
