...
analysis.dir <-  "/home/heyj/omics/groups/OE0219/internal/jmmlc_pbat/data/odcf_md/analysis/200608_DMR_model_sub"
...
contrasts <- list(EpigenotypeHM=list(HM=rownames(pheno[pheno$Epigenotype=="HM",]), LM=rownames(pheno[pheno$Epigenotype=="LM",])),
    tumortumor00=list(tumor01=rownames(pheno[pheno$tumor=="tumor00",]), remains=rownames(pheno[pheno$tumor=="tumor01",])),
    tumortumor10=list(tumor10=rownames(pheno[pheno$tumor=="tumor10",]), remains=rownames(pheno[pheno$tumor=="tumor01",])),
    tumortumor11=list(tumor11=rownames(pheno[pheno$tumor=="tumor11",]), remains=rownames(pheno[pheno$tumor=="tumor01",])))
