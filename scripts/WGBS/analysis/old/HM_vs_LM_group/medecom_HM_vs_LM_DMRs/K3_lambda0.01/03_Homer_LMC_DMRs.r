...
#run in command line
cd /home/heyj/icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/analysis/200519_DMR_HM_vs_LM/medecom/downstream_combined_K3_lambda0.01.01/homer
...
#get motif locations
cd /icgc/dkfzlsdf/analysis/C010/cancer_microenvironment/TAM/WGBS/analysis/BMDM_TAM_MG_onlyPBAT/DMR/medecom/downstream_combined_K3_lambda0.01.01/homer
