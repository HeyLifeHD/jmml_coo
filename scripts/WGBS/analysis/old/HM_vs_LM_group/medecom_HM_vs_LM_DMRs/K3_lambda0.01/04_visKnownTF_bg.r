...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer",i, paste0("HomerBubble_all_qval0.05_bg.pdf")), height=40)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer",i, paste0("HomerBubble_all_qval0.05_bg_v2.pdf")), height=7)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer", i,paste0("HomerBubble_top10_qval0.05_bg.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer", paste0("combined_",i,"_HomerBubble_all_qval0.05_bg.pdf")), height=45, width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer", paste0("combined_",i,"_HomerBubble_top10_qval0.05_bg.pdf")), width=12)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer", paste0("combined_",i,"_HomerBubble_top5_qval0.05_bg.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K3_lambda0.01/homer", paste0("combined_",i,"_HomerBubble_top3_qval0.05_bg.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
