...
knownRes <- list.files(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer"), pattern="knownResults$", full.names = TRUE, recursive = TRUE, include.dirs= TRUE)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer",i, paste0("HomerBubble_all_qval0.05_bg.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}

#plot all sig motifs version 2 (small)
DAR_list_sub <- list()
DAR_list_sub_sig <- list()
DAR_list_sub_plot<-list()
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer",i, paste0("HomerBubble_all_qval0.05_bg_v2.pdf")), height=7)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer", i,paste0("HomerBubble_top10_qval0.05_bg.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
...
unique(sapply(names_knownRes, function(x) x[16]))
DAR_list <- list()
for(i in c("LMC_03", "LMC_04", "LMC_05") ){
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_all_qval0.05_bg.pdf")), height=45, width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top10_qval0.05_bg.pdf")), width=12)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top5_qval0.05_bg.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined_K8_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top3_qval0.05_bg.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
