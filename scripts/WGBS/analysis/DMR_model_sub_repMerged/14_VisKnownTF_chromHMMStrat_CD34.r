...
knownRes <- list.files(file.path(analysis.dir, "homer_CD34_Strat"), pattern="knownResults$", full.names = TRUE, recursive = TRUE, include.dirs= TRUE)
...
names_knownRes_sub <- sapply(names_knownRes, function(x) paste0(x[15]))
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hyper_qval0.05.pdf")), height=40)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hyper_qval0.1.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hyper_top3.pdf")), height=7)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hypo_qval0.05.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hypo_qval0.1.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir,"homer_CD34_Strat", paste0("HomerBubble_hypo_top3.pdf")), height=7)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
