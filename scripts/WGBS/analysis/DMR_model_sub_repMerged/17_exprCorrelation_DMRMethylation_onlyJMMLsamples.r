...
names(files)<- paste0("EpigenotypeHM")
...
paste0(unique(deg_overlap$upregulated$EpigenotypeHM$symbol), collapse=", ")
paste0(unique(deg_overlap$downregulated$EpigenotypeHM$symbol), collapse=", ")
