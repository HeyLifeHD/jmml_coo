...
knownRes <- list.files(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer"), pattern="knownResults$", full.names = TRUE, recursive = TRUE, include.dirs= TRUE)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer",i, paste0("HomerBubble_all_qval0.05.pdf")), height=40)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer", i,paste0("HomerBubble_top10_qval0.05.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_all_qval0.05.pdf")), height=60, width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top10_qval0.05.pdf")), width=12)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top5_qval0.05.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_K3_lambda0.001/homer", paste0("combined_",i,"_HomerBubble_top3_qval0.05.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
    theme(text = element_text(size=8),
    axis.text.x = element_text(size = 8),
    axis.text.y = element_text(size = 8)
