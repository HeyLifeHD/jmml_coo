...
dir.create(file.path(analysis.dir, "medecom","downstream_K3_lambda0.001"))
saveRDS(dmr_LMC_05, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_05.rds"))
...
names(dmr_LMC_04)<- c("LMC1","LMC2", "LMC3")
lapply(dmr_LMC_04, function(x)lapply(x, function(y)length(y)))
#unique(as.factor(dmr_LMC_08$LMC1$hypo$SYMBOL))
saveRDS(dmr_LMC_04, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_04.rds"))
...
names(dmr_LMC_03)<- c("LMC1","LMC2", "LMC3")
lapply(dmr_LMC_03, function(x)lapply(x, function(y)length(y)))
#unique(as.factor(dmr_LMC_08$LMC1$hypo$SYMBOL))
saveRDS(dmr_LMC_03, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_03.rds"))
...
#unique(as.factor(dmr_LMC_08$LMC1$hypo$SYMBOL))
saveRDS(dmr_LMC_08, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_08.rds"))
...
saveRDS(dmr_LMC_07, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_07.rds"))
...
names(dmr_LMC_03_all)<- c("LMC1","LMC2", "LMC3")
lapply(dmr_LMC_03_all, function(x)length(x))
#unique(as.factor(dmr_LMC_07$LMC1$hypo$SYMBOL))
saveRDS(dmr_LMC_03_all, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_03_all.rds"))
...
#save files
dir.create(file.path(analysis.dir, "medecom","downstream_K3_lambda0.001"))
saveRDS(dmr_LMC_list_unlist, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_list_unlist.rds"))
saveRDS(dmr_LMC_list_promoters_unlist, file.path(analysis.dir, "medecom","downstream_K3_lambda0.001", "dmr_LMC_list_promoters_unlist.rds"))
