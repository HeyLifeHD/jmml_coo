...
#run in command line
cd /home/heyj/icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/analysis/200612_DMR_model_sub_repMerged/medecom/downstream_K8_lambda0.001/homer
chmod 777 -R ./
...
#get motif locations
cd /icgc/dkfzlsdf/analysis/C010/cancer_microenvironment/TAM/WGBS/analysis/BMDM_TAM_MG_onlyPBAT/DMR/medecom/downstream_K8_lambda0.001/homer
