...
fname=`basename $pid`
echo $pid
samtools merge -f /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}.bam /icgc/dkfzlsdf/project/OE0219/JMMLC_PBAT/sequencing/whole_genome_bisulfite_tagmentation_sequencing/view-by-pid/$pid/*/paired/merged-alignment/*.bam
#samtools sort  /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}.bam > /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}_sorted.bam
#samtools index /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}_sorted.bam
done


#kick out tumor11_JMMLC_D129_1
samtools merge -f /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/JMMLC_D129_PBAT.bam JMMLC_D129_PBAT/tumor00-1/paired/merged-alignment/tumor00-1_JMMLC_D129_PBAT_merged.mdup.bam JMMLC_D129_PBAT/tumor10-1/paired/merged-alignment/tumor10-1_JMMLC_D129_PBAT_merged.mdup.bam
...
fname=`basename $pid`
echo $pid
samtools sort  --threads 6 /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}.bam > /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}_sorted.bam
samtools index /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/${pid}_sorted.bam
done
...
mkdir /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/analysis/gatk/gatk_output_merged/
chmod 777 -R /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/analysis/gatk/gatk_output_merged/

docker run -it --mount type=bind,source=/icgc2/,target=/icgc/ broadinstitute/gatk
OUTPUT_DIR=/icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/analysis/gatk/gatk_output_merged/

for patient in `ls /icgc/dkfzlsdf/analysis/C010/jmmlc_pbat/data/odcf_md/merged_bam/*_sorted.bam`;
do
echo $patient
